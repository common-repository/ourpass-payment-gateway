...
function ourpasswc_enqueue_script()
{
	wp_enqueue_style(
		'ourpasswc-css',
		OURPASSWC_URL . 'assets/dist/ourpasswc.css',
		array(),
		OURPASSWC_VERSION
	);
	...
	wp_enqueue_script(
		'ourpasswc-js',
		OURPASSWC_URL . 'assets/dist/ourpasswc.js',
...
function ourpasswc_admin_enqueue_scripts()
{
	...
	wp_enqueue_script(
		'ourpasswc-admin-js',
		OURPASSWC_URL . 'assets/dist/ourpasswc-admin.js',
	...
	wp_enqueue_style(
		'ourpasswc-admin-css',
		OURPASSWC_URL . 'assets/dist/ourpasswc-admin.css',
		array(),
		OURPASSWC_VERSION
	);
}
